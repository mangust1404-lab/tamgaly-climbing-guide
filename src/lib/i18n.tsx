...
const translations = {
  ...
  'install.androidStep2b': { ru: 'Установить приложение / Добавить на главный экран', en: 'Install app / Add to Home screen', kk: 'Орнату' },
  'install.androidStep3Title': { ru: 'Подтверди', en: 'Confirm', kk: 'Растау' },
  'install.androidStep3': { ru: 'Нажми "Установить". Иконка появится на главном экране телефона.', en: 'Tap "Install". Icon will appear on home screen.', kk: 'Орнатуды басыңыз' },
