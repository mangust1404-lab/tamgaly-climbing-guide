...
const translations = {
  ...
  'nav.board': { ru: 'Доска', en: 'Board', kk: 'Тақта' },
  'board.title': { ru: 'Доска объявлений', en: 'Board', kk: 'Хабарландырулар' },
  'board.create': { ru: 'Объявление', en: 'Post', kk: 'Хабарландыру' },
  'board.gear': { ru: 'Барахолка', en: 'Gear', kk: 'Снаряжение' },
  'board.partner': { ru: 'Напарник', en: 'Partner', kk: 'Серіктес' },
  'board.ride': { ru: 'Попутчик', en: 'Ride', kk: 'Жолсерік' },
  'board.create_gear': { ru: 'Продажа/покупка', en: 'Sell/buy gear', kk: 'Сатамын/сатып аламын' },
  'board.create_partner': { ru: 'Поиск напарника', en: 'Looking for partner', kk: 'Серіктес іздеу' },
  'board.create_ride': { ru: 'Поиск попутчика', en: 'Looking for ride', kk: 'Жолсерік іздеу' },
  'board.empty': { ru: 'Пока нет объявлений', en: 'No posts yet', kk: 'Әзірге хабарландыру жоқ' },
  'board.yours': { ru: 'Твои объявления', en: 'Your posts', kk: 'Сіздің хабарландырулар' },
  'board.publish': { ru: 'Опубликовать', en: 'Publish', kk: 'Жариялау' },
  'board.close': { ru: 'Закрыть', en: 'Close', kk: 'Жабу' },
  'board.reopen': { ru: 'Открыть снова', en: 'Reopen', kk: 'Қайта ашу' },
  'board.delete': { ru: 'Удалить', en: 'Delete', kk: 'Жою' },
  'board.closed': { ru: 'Закрыто', en: 'Closed', kk: 'Жабық' },
  'board.confirmDelete': { ru: 'Удалить объявление?', en: 'Delete post?', kk: 'Хабарландыруды жою керек пе?' },
  ...
  'install.title': { ru: 'Установка приложения', en: 'Install the app', kk: 'Қолданбаны орнату' },
  'install.intro': { ru: 'Чтобы пользоваться без браузера, добавь на главный экран. Тогда работает офлайн и быстрее.', en: 'To use without browser, add to home screen for offline mode.', kk: 'Браузерсіз пайдалану үшін басты экранға қосыңыз.' },
  'install.bigButton': { ru: 'Установить приложение', en: 'Install app', kk: 'Қолданбаны орнату' },
  'install.alreadyInstalled': { ru: 'Уже установлено!', en: 'Already installed!', kk: 'Орнатылған!' },
  'install.alreadyText': { ru: 'Ты пользуешься приложением. Можно вернуться на главную.', en: 'You are using the app.', kk: 'Сіз қолданбаны пайдаланып жатырсыз.' },
  'install.openHome': { ru: 'На главную', en: 'Home', kk: 'Басты бет' },
  'install.desktop': { ru: 'Компьютер', en: 'Desktop', kk: 'Компьютер' },
  'install.androidStep1Title': { ru: 'Открой в Chrome', en: 'Open in Chrome', kk: 'Chrome-да ашу' },
  'install.androidStep1': { ru: 'Скопируй адрес tamgalyclimb.alexanderlobanov.de и открой в Chrome (или другом браузере).', en: 'Copy tamgalyclimb.alexanderlobanov.de and open in Chrome.', kk: 'Chrome-да ашыңыз' },
  'install.androidTGNote': { ru: 'Если открыто в Telegram — нажми три точки наверху и "Открыть в браузере".', en: 'If opened in Telegram — tap menu and "Open in browser".', kk: 'Telegram-да ашылса — браузерде ашыңыз' },
  'install.androidStep2Title': { ru: 'Меню браузера', en: 'Browser menu', kk: 'Браузер мәзірі' },
  'install.androidStep2a': { ru: 'Нажми три точки в правом верхнем углу.', en: 'Tap three dots in top right.', kk: 'Үш нүктені басыңыз' },
  'install.androidStep2b': { ru: 'Добавить на главный экран → Установить приложение', en: 'Add to Home screen → Install app', kk: 'Орнату' },
  'install.androidStep3Title': { ru: 'Подтверди', en: 'Confirm', kk: 'Растау' },
  'install.androidStep3': { ru: 'После нажатия "Добавить на главный экран" появится диалог "Установить приложение". Нажми Установить — иконка появится на главном экране.', en: 'After tapping "Add to Home screen", an "Install app" dialog appears. Tap Install — icon appears on home screen.', kk: 'Орнатуды басыңыз' },
  'install.iosStep1Title': { ru: 'Открой в Safari', en: 'Open in Safari', kk: 'Safari-да ашу' },
  'install.iosStep1': { ru: 'Скопируй адрес tamgalyclimb.alexanderlobanov.de и открой в Safari.', en: 'Copy and open in Safari.', kk: 'Safari-да ашыңыз' },
  'install.iosTGNote': { ru: 'Если открыто в Telegram — нажми три точки внизу и "Открыть в Safari".', en: 'If in Telegram — tap menu and "Open in Safari".', kk: 'Safari-да ашыңыз' },
  'install.iosStep2Title': { ru: 'Кнопка Поделиться', en: 'Share button', kk: 'Бөлісу батырмасы' },
  'install.iosStep2a': { ru: 'Внизу экрана нажми кнопку "Поделиться" — квадрат со стрелкой вверх.', en: 'Tap Share button at bottom (square with arrow up).', kk: 'Бөлісу батырмасын басыңыз' },
  'install.iosStep2b': { ru: 'На экран Домой', en: 'Add to Home Screen', kk: 'Басты экранға' },
  'install.iosStep3Title': { ru: 'Подтверди', en: 'Confirm', kk: 'Растау' },
  'install.iosStep3': { ru: 'Нажми "Добавить" в правом верхнем углу. Иконка появится на главном экране.', en: 'Tap "Add" in top right.', kk: 'Қосуды басыңыз' },
  'install.step4Title': { ru: 'Готово!', en: 'Done!', kk: 'Дайын!' },
  'install.step4': { ru: 'Открой иконку приложения с главного экрана. Зарегистрируйся (имя + пароль).', en: 'Open the app icon. Register name + password.', kk: 'Тіркеліңіз' },
  'install.desktopText': { ru: 'На компьютере приложение работает прямо в браузере.', en: 'On desktop the app works in the browser.', kk: 'Компьютерде браузерде жұмыс істейді' },
  'install.openInBrowser': { ru: 'Открыть в браузере', en: 'Open in browser', kk: 'Браузерде ашу' },
  'install.askForHelp': { ru: 'Не получается? Напиши:', en: 'Need help? Contact:', kk: 'Көмек қажет пе?' },
  ...
  'board.fieldGradeFrom': { ru: 'Категория от', en: 'Grade from', kk: 'Категория' },
  'board.fieldGradeTo': { ru: 'до', en: 'to', kk: 'дейін' },
  ...
  'board.labelPrice': { ru: 'Цена', en: 'Price', kk: 'Бағасы' },
  'board.labelDate': { ru: 'Когда', en: 'When', kk: 'Қашан' },
  'board.labelSector': { ru: 'Сектор', en: 'Sector', kk: 'Сектор' },
  'board.labelGradeRange': { ru: 'Диапазон категорий', en: 'Grade range', kk: 'Категория ауқымы' },
  'board.labelRoute': { ru: 'Маршрут', en: 'Route', kk: 'Бағыт' },
  'board.labelFreeSeats': { ru: 'Свободных мест в машине', en: 'Free seats in car', kk: 'Көлікте бос орындар' },
  'board.labelPeopleCount': { ru: 'Сколько вас человек', en: 'How many of you', kk: 'Қанша адам' },
  'board.quickFrom': { ru: 'Часто:', en: 'Common:', kk: 'Жиі:' },
  ...
  'profile.settings': { ru: 'Настройки', en: 'Settings', kk: 'Баптаулар' },
  'profile.contacts': { ru: 'Контакты', en: 'Contacts', kk: 'Байланыс' },
  'profile.privacy': { ru: 'Приватность', en: 'Privacy', kk: 'Жекелік' },
  'profile.privacyAll': { ru: 'Все', en: 'Everyone', kk: 'Барлығы' },
  'profile.privacyFriends': { ru: 'Друзья', en: 'Friends', kk: 'Достар' },
  'profile.privacyNobody': { ru: 'Никому', en: 'Nobody', kk: 'Ешкімге' },
  'profile.privacyRoutes': { ru: 'Пройденные маршруты', en: 'Climbed routes', kk: 'Өткен маршруттар' },
  'profile.privacyAchievements': { ru: 'Ачивки', en: 'Achievements', kk: 'Жетістіктер' },
  'profile.privacyMaxGrade': { ru: 'Макс. категория', en: 'Max grade', kk: 'Ең жоғарғы категория' },
  'profile.privacyStats': { ru: 'Очки и статистика', en: 'Score & stats', kk: 'Ұпайлар' },
  'profile.privacyPyramid': { ru: 'Пирамида категорий', en: 'Grade pyramid', kk: 'Категория пирамидасы' },
  'profile.privacyDates': { ru: 'Даты пролазов', en: 'Ascent dates', kk: 'Өрмелеу күндері' },
  'profile.privacyContacts': { ru: 'Контакты (TG/WA)', en: 'Contacts (TG/WA)', kk: 'Байланыс' },
  'profile.subscribeChannel': { ru: 'Подпишись на канал новостей', en: 'Subscribe to news channel', kk: 'Жаңалықтар арнасына жазылыңыз' },
  'profile.privacyProjects': { ru: 'Проекты', en: 'Projects', kk: 'Жобалар' },
  'profile.privacyGradeVotes': { ru: 'Голоса за категории', en: 'Grade votes', kk: 'Категория дауысы' },
  'saved': { ru: 'Сохранено', en: 'Saved', kk: 'Сақталды' },
  'loading': { ru: 'Загрузка...', en: 'Loading...', kk: 'Жүктелуде...' },
  'publicProfile.notFound': { ru: 'Профиль не найден', en: 'Profile not found', kk: 'Профиль табылмады' },
  'publicProfile.private': { ru: 'Профиль скрыт', en: 'Profile is private', kk: 'Профиль жабық' },
  'publicProfile.joined': { ru: 'С нами с', en: 'Joined', kk: 'Қосылған' },
  'publicProfile.climbedRoutes': { ru: 'Пройденные маршруты', en: 'Climbed routes', kk: 'Өткен маршруттар' },
  'publicProfile.moreRoutes': { ru: 'ещё маршрутов', en: 'more routes', kk: 'қосымша маршрут' },
  'publicProfile.editProfile': { ru: 'Редактировать профиль', en: 'Edit profile', kk: 'Профильді өзгерту' },
  'publicProfile.projects': { ru: 'Проекты', en: 'Projects', kk: 'Жобалар' },
  'publicProfile.gradeVotes': { ru: 'Голоса за категории', en: 'Grade votes', kk: 'Категория дауыстары' },
  'publicProfile.backToLeaderboard': { ru: 'К рейтингу', en: 'To leaderboard', kk: 'Рейтингке' },
  'friend.title': { ru: 'Друзья', en: 'Friends', kk: 'Достар' },
  'friend.incomingTitle': { ru: 'Запросы в друзья', en: 'Friend requests', kk: 'Достық сұраныстары' },
  'friend.add': { ru: 'Добавить в друзья', en: 'Add friend', kk: 'Дос ретінде қосу' },
  'friend.accept': { ru: 'Принять', en: 'Accept', kk: 'Қабылдау' },
  'friend.reject': { ru: 'Отклонить', en: 'Reject', kk: 'Қабылдамау' },
  'friend.cancel': { ru: 'Отменить', en: 'Cancel', kk: 'Бас тарту' },
  'friend.unfriend': { ru: 'Удалить', en: 'Unfriend', kk: 'Жою' },
  'friend.requestSent': { ru: 'Запрос отправлен', en: 'Request sent', kk: 'Сұраныс жіберілді' },
  'friend.statusFriends': { ru: 'Вы друзья', en: 'You are friends', kk: 'Сіздер достарсыздар' },
  'friend.empty': { ru: 'Друзей пока нет. Найди и добавь!', en: 'No friends yet. Find and add!', kk: 'Достар жоқ. Іздеп қос!' },
  'friend.find': { ru: 'Найти', en: 'Find', kk: 'Іздеу' },
  'friend.findTitle': { ru: 'Найти друга', en: 'Find a friend', kk: 'Дос іздеу' },
  'friend.findPlaceholder': { ru: 'Имя пользователя', en: 'Username', kk: 'Қолданушы аты' },
  'friend.search': { ru: 'Искать', en: 'Search', kk: 'Іздеу' },
  'friend.noResults': { ru: 'Никого не найдено', en: 'Nobody found', kk: 'Ешкім табылмады' },
  'home.friendRequestOne': { ru: 'хочет добавить тебя в друзья', en: 'wants to add you as a friend', kk: 'досқа қосқысы келеді' },
  'home.friendRequestMany': { ru: 'новых запросов в друзья', en: 'new friend requests', kk: 'жаңа достық сұранысы' },
  ...
  'profile.customDates': { ru: 'Даты', en: 'Dates', kk: 'Күндер' },
  ...
  'suggest.photosSent': { ru: 'фото отправлено', en: 'photos sent', kk: 'фото жіберілді' },
  'suggest.morePhotos': { ru: 'Ещё фото', en: 'More photos', kk: 'Тағы фото' },
  'suggest.done': { ru: 'Готово', en: 'Done', kk: 'Дайын' },
